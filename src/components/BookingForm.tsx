...
export default function BookingForm() {
  ...
  const inputClass =
    'w-full bg-[#0d0d0d] border border-[rgba(214,168,79,0.2)] text-[#F5F1E8] text-sm px-4 py-3.5 placeholder-[#555] focus:outline-none focus:border-gold-DEFAULT transition-colors duration-300 hover:border-[rgba(214,168,79,0.4)]'
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div className={`transition-all duration-700 ${visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <h2 className="section-title mb-6">
              Записаться на<br />
              <em style={{ color: '#D6A84F', fontStyle: 'italic' }}>диагностику</em>
            </h2>
            <p className="text-[#A8A8A8] text-sm leading-relaxed mb-10 max-w-[400px]">
              Оставьте заявку, и мы свяжемся с вами, чтобы подобрать удобное время и рассчитать стоимость работ.
            </p>
            ...
            <div className="mt-12 w-full max-w-[280px]">
              <div className="h-px" style={{ background: 'linear-gradient(to right, rgba(214,168,79,0.5), transparent)' }} />
              <p className="text-[#555] text-xs mt-4 tracking-wide">Без предоплаты. Без скрытых комиссий.</p>
            </div>
          </div>
          ...
          >
            {submitted ? (
              ...
              >
                <div className="w-16 h-16 mx-auto mb-6 flex items-center justify-center border border-gold-DEFAULT">
              ...
              >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
                  ...
                  <div>
                    <label className="block text-[10px] tracking-[0.2em] text-[#A8A8A8] uppercase mb-2">Желаемая услуга</label>
                    <select
                      name="service"
                      value={form.service}
                      onChange={handleChange}
                ...
                <p className="text-[#555] text-[11px] text-center mt-4 tracking-wide">
